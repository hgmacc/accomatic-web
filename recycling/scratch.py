...
for m in all_accordance_funcs:
    ...
    pop_sample = all_accordance_old_results[m]
    ...
    for col in pop_sample:
        ...
        for i in range(0, resample_freq):
            ...
            t_stat = (mean(bootstrap_sample) - current_sample_mean) / stats.sem(
                bootstrap_sample
            )
        ...
        ci_max_series[col] = (
            current_sample_mean - resample_deltas[lower_ci] * current_sample_sem
        )
        ci_min_series[col] = (
            current_sample_mean - resample_deltas[upper_ci] * current_sample_sem
        )
