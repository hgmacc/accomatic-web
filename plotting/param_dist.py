...
def plot_par_distribution():
    ...
    # Plot titles
    titles = ["Terrain Wetness", "Snow Collection", "Incoming Solar Radiation"]

    index = 1  # Given to keep track of plot index (1 - 6)
    for par_i in range(3):
        # Top row: Distriubution of raster data and observed plot values
    ...
    plt.savefig("/home/hma000/accomatic-web/thesis/plots/plot_par_distribution.png")
