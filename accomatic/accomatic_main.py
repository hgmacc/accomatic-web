...
def main():
    mainparser = argparse.ArgumentParser(description="Accomatic: Analysis of point-scale simulation.",
                                         formatter_class=argparse.ArgumentDefaultsHelpFormatter)

    subparsers = mainparser.add_subparsers()
    run = subparsers.add_parser("run", description="Run accomatic based on config file settings.")
    mainparser.add_argument("--version", action='version', version=f"Accomatic version {__version__}")
